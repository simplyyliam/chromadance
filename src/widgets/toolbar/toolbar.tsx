...
export default function Toolbar() {
  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Allows selecting the same file twice in a row
    // and still firing onChange.
    event.target.value = "";
  };
    ...
    >
      ...
      >
        <IconButton
          ...
          variant="ghost"
          className={`w-25 h-11.5 rounded-full transition-colors ${isShaderEnabled
              ? "bg-muted"
        ...
        <motion.div
          ...
          className="flex px-6 h-11.5 items-center justify-center rounded-full bg-muted"
        >
