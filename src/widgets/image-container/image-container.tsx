  ...
  return (
    <>
      <motion.div
        ...
        className={`relative z-40 flex h-[60svh] w-[55svw] items-center justify-center overflow-hidden bg-klein shadow-2xl rounded-xl transition-colors ${isDragging ? 'ring-2 ring-inset ring-primary' : ''}`}
